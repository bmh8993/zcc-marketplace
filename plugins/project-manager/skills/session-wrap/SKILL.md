...
| Agent | Role | Output |
|-------|------|--------|
| **doc-updater** | Analyze all 5 memory types (CLAUDE.md, CLAUDE.local.md, MEMORY.md, .claude/rules/*, context.md) | Specific content to add, rules directory setup recommendations |
